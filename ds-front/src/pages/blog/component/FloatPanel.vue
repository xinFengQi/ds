<template>
  <div class="float-panel mobile-only blur" style="display: none">
    <button
      type="button"
      :class='{ "sidebar-toggle": true, "mobile": true , "mobile-clolor": mobleSiderStatus }'
      @click="toggle()"
    >
      <svg
        class="icon"
...
export default class FloatPanel extends Vue {
  mounted() {}
  ...
  toggle() {
    store.dispatch("setMobleSiderStatus", !this.mobleSiderStatus);
  }
}
</script>
