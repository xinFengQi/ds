...
模板编译器是用TypeScript构建的，在npm上发布。它的发行版包括类型，这使得开发人员更容易使用Stencli Api。
...
Stencli可以在现代浏览器和IE11上运行

### Stencli提供什么样的 polyfills 
...
如果这是您第一次建立一个设计系统或者新的Stencli，[取得联系](https://ionicframework.com/sales?product_of_interest=Design%20Systems)是我们的解决方案工程师一个关于如何实现你的目标磋商和利用的平台。
