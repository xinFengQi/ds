...
<pre><code class="language-javascript">
  ...
  @export
  @Interface IVisitorInfo</code></pre>
...
<pre><code class="language-javascript"> 键值类型'''
...
<pre><code class="language-javascript"> 按钮类型'''
...
<pre><code class="language-javascript"> 表单模型配置'''
...
<pre><code class="language-javascript"> 输入组配置数据'''
...
<pre><code class="language-javascript"> 日期开始结束选择框配置'''
...
<pre><code class="language-javascript"> 条件选择的配置'''
...
<pre><code class="language-javascript"> 表单元素基础配置'''
...
<pre><code class="language-javascript"> 富文本配置'''
...
<pre><code class="language-javascript"> 上传组件配置'''
...
<pre><code class="language-javascript"> 表单订阅中心数据'''
